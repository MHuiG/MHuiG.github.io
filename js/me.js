...
if((!Supports.arrow)){
	if(window.location.pathname.split("/").length>=1){
		if(window.location.pathname.split("/")[1]!="ie"){
			//console.log(window.location.pathname.split("/"));
			var s="";
			for(var i=0;i<window.location.pathname.split("/").length;i++){
				if(i==window.location.pathname.split("/").length-1){
					s+= window.location.pathname.split("/")[i];
				}else{
					s+= window.location.pathname.split("/")[i]+"/";
				}
				if(i==0){
...
if((window.location.host!="mhuig.github.io")&&(window.location.host!="localhost:4000")&&(window.location.host!="mhuig.gitlab.io")&&(window.location.host!="thepie.top")&&(window.location.host!="mhuig.top")){
	window.location.host="mhuig.github.io:443";
}
